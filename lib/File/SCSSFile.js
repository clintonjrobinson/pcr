...
class SCSSFile extends File {
  ...
  get development() {
    if (!this._development) {
      if (this.forPolymerElement) {
        ...
        this._development = `<link rel="stylesheet" charset="utf-8" type="text/css" href="/pcr/ui/${this.ui.name}/${this.name}">\n`;
      }
    }
  ...
  get production() {
    if (!this._production) {
      this._production = cleanCss.minify(this.transformed).styles;
    }
...
exports = module.exports = SCSSFile;